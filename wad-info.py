...
def find_offsets(header_size, cert_size, tik_size, tmd_size, data_size, footer_size):
	...
	#Although the end points are returned by find_offsets, they are not currently used.
	return [
	[cert_start, cert_end],
	[tik_start, tik_end],
	[tmd_start, tmd_end],
...
def csv_dump(offsets, file, filename):
	...
	title_ver = str(dec_u16(encode(file.read(2), 'hex').decode('ascii'))).zfill(4)
	print("{},{},{},\"{}\"".format(title_id, title_ver, titlekey_enc, filename))
...
if __name__ == "__main__":
	...
	main(arguments.csv, arguments.header, arguments.batch, arguments.i, arguments.path)